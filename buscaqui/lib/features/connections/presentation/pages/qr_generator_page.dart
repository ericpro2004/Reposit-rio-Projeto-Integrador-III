...
/// Tela 7 — Gerador de QR Code (visão motorista). Exibe o QR da conexão, o
/// token em texto abaixo e ações de Compartilhar e Atualizar token.
...
class _QrGeneratorPageState extends ConsumerState<QrGeneratorPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(_conexao.nomeConexao)),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Center(
              child: Semantics(
                image: true,
                label:
                    'QR Code da conexão ${_conexao.nomeConexao}. Código em texto: '
                    '${_conexao.codigo}.',
                child: Container(
                  ...
                  child: QrImageView(
                    ...
                    size: 240,
                    // Sempre fundo claro + módulos escuros (contraste alto p/ leitura).
            ...
            const SizedBox(height: 24),
            // Token em texto, selecionável e copiável.
            Center(
              child: Semantics(
